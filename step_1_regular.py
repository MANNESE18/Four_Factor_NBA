...
# ── Config ───────────────────────────────────────────────────────────────────
SEASON    = 2026
DB_PATH   = "step_1_regular.db"
SLEEP_SEC = 3
TABLE_ID  = "team_game_log_adv_reg"
...
def main():
    ...
    print(f"Starting Regular Season Scraping to {DB_PATH}...")
    for team in ALL_TEAMS:
        ...
        try:
            ...
            df.to_sql(f"{team}_regular", conn, if_exists="replace", index=False)
            print(f"  ✓ {team} saved.")
